...
const ProductsManagement = () => {
  ...
  useEffect(() => {
    const fetchProducts = async () => {
      try {
        setLoading(true);
        const response = await apiService.getAllProducts(currentPage, 12);
          ...
          <div key={product.id} className="bg-white dark:bg-gray-800 rounded-lg shadow overflow-hidden">
            <div className="relative">
              ...
              <div className="h-40 md:h-48 bg-gray-200 dark:bg-gray-700 flex items-center justify-center">
                {(product.imageUrl || product.imageUrlThumbnail || product.image) ? (
                  <img
                    src={product.imageUrl || product.imageUrlThumbnail || product.image}
                    alt={product.name}
                ...
                <div className={`${(product.imageUrl || product.imageUrlThumbnail || product.image) ? 'hidden' : 'flex'} items-center justify-center w-full h-full`}>
